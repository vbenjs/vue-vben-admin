...
<template>
  <VbenAdminLayout
    ...
    :content-padding="preferences.content.padding"
    :content-padding-bottom="preferences.content.paddingBottom"
    :content-padding-left="preferences.content.paddingLeft"
    :content-padding-right="preferences.content.paddingRight"
    :content-padding-top="preferences.content.paddingTop"
