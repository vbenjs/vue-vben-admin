        ...
        <a-list-item-meta>
          <template #title>
            <div class="flex justify-between">
              ...
              <div @click="handleActionClick(item)">
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      watch(
        ...
        (val) => {
          if (val.length === 0) {
            emit('update:currentPage', current.value - 1 || 1);
          }
        },
      );
      ...
      function handleActionClick(item: ListItem) {
        props.onActionClick && props.onActionClick(item);
      }
