<template>
  <div class="p-4">
    ...
    <div class="w-full enter-y">
      <StoreYearPower class="mb-4" :height="height" :storeId="storeId" :year="year" />
      <StoreQoq :height="height" :storeId="storeId" :year="year" />
    </div>
  </div>
</template>
<script lang="ts" setup name="StoreQoq">
  import StoreYearPower from './components/StoreYearPower.vue';
  import StoreQoq from './components/StoreQoq.vue';
