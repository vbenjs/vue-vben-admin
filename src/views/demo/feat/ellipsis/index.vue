<template>
  <PageWrapper title="文本省略示例">
    <CollapseContainer class="w-full h-32 bg-white rounded-md" title="Ellipsis 基本使用">
      <EllipsisText :maxWidth="240">{{ text }}</EllipsisText>
    </CollapseContainer>
    <CollapseContainer class="w-full h-32 bg-white rounded-md" title="Ellipsis 多行省略">
      <EllipsisText :line="2">{{ text }}</EllipsisText>
    </CollapseContainer>
    <CollapseContainer class="w-full h-32 bg-white rounded-md" title="Ellipsis 点击展开">
      <EllipsisText expand :line="2">{{ text }}</EllipsisText>
    </CollapseContainer>
    <CollapseContainer class="w-full h-32 bg-white rounded-md" title="Ellipsis 定制 Tooltip 内容">
