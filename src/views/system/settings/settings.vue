...
<script lang="ts" setup>
  ...
  defineOptions({
    name: 'SystemSet',
    components: {
      OtherSettings: defineAsyncComponent(() => import('./other/index.vue')),
      RemindMessage: defineAsyncComponent(() => import('./remind/message/index.vue')),
      RemindTemplate: defineAsyncComponent(() => import('./remind/template/index.vue')),
      BusinessTime: defineAsyncComponent(() => import('./time/index.vue')),
    },
  });

  const prefixCls = 'base-settings';
