...
import { SimpleMenu, SimpleMenuTag } from '@/components/simple-menu'
...
import { SIDE_BAR_MINI_WIDTH, SIDE_BAR_SHOW_TIT_MINI_WIDTH } from '@pkg/tokens'
import { clickOutside } from '@pkg/directives'
import {
  getChildrenMenus,
