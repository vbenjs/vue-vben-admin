...
import { getSupplierListApi, deleteSupplierApi } from '#/api';
...
const handleEdit = (row: SupplierApi.SupplierItem) => {
  modalApi.setData(row).open();
};
const handleDelete = (row: SupplierApi.SupplierItem) => {
  Modal.confirm({
    icon: null,
    centered: true,
    maskClosable: false,
...
<template>
  <Page auto-content-height>
    ...
    <SupplierModal @refresh="handleRefresh" />
  </Page>
</template>
