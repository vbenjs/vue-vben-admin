import{i as o}from"./mock-api-Z4lqjgbK.js";import{P as h}from"./index-ByQC-ZMP.js";import{b6 as e,W as D,R as p,B as f}from"./antd-D1Pawy5U.js";import{d as r,k as u,G as t,f as m,u as d,c as g,r as F}from"./vue-COhTiP8A.js";import{u as i}from"./index-BZisrYpU.js";import"./entry/index-DN3d1Q0w-1711520613238.js";import"./useContentViewHeight-apgiPR5W.js";import"./useWindowSizeFn-BPGCouEx.js";import"./onMountedOrActivated-GpUdBAv_.js";const C=[{label:"Jack",value:"Jack"},{label:"Lucy",value:"Lucy"},{label:"Lutz",value:"Lutz"}],v=r({setup(){const a=m("Lutz"),{data:n,loading:l}=i(()=>o(a.value),{refreshDeps:[a]});return()=>u(p,{title:"Ref 依赖刷新"},{default:()=>[u(e,null,{default:()=>[u(e.Paragraph,null,{default:()=>[t("useRequest 提供了一个"),u(e.Text,{type:"danger"},{default:()=>[t(" options.refreshDeps ")]}),t("参数，当它的值变化后，会重新触发请求。")]}),u(e.Paragraph,null,{default:()=>[u(e.Text,null,{default:()=>[u("pre",null,[`const select = ref('Lutz');
